...
| **The state reporter has never read a real deployment.** 46 tests, all against fixtures. The first person to run it against a live estate finds what fixtures cannot. | [#5](https://github.com/Vexa-ai/vexa-delivery/issues/5) |
