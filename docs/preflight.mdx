...
**Preflight answers one question before anything is installed: will this cluster run what the channel delivers?** It fails closed, so a conflict with your taints, quotas or admission profile surfaces now instead of during your first sync. Run it again before every upgrade.
