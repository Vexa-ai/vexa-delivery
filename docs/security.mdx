...
This is an open-source collaboration: Vexa, the delivery machinery, and everything that will ever travel through the channel is Apache-2.0. [Both paths](how-it-works#channels--open-or-private) run the same software.
