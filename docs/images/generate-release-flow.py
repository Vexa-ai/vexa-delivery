...
def render(P):
    ...
    e.append(card(120, "Vexa staging", "a Vexa Delivery unit", P, False))
    e.append(card(423, "Vexa production", "a Vexa Delivery unit", P, False))
    e.append(card(727, "Your staging", "a Vexa Delivery unit — yours", P, True))
    e.append(card(1030, "Your production", "a Vexa Delivery unit — yours", P, True))
