...
<Accordion title="state-report.yaml — complete, 213 lines">

```yaml
# vexa-state-report 0.4.0 — the shape of this deployment's environment.
#
...
tool_version: '0.4.0'
schema_version: 4
generated_at: '2026-08-27T20:38:18Z'
...
platform:
  ...
  cloud: Linode
  node_shapes_note: 'grouped by shape; node names are not collected'
  node_shapes:
    - count: 2
