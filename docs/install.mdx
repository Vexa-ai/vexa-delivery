...
Writes `station.tar.gz` — your profile, your values with secrets redacted, the contract, and the receipts. Read it, then send it: by hand, or with `--submit`, which pushes it to [your own path on the channel](station-gate) using your own credential.
