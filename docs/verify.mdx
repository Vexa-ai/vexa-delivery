...
**2 — The evidence bundle is intact.** Recompute the sha256 of every file in `evidence/` and compare to `entry.json` — a five-line script in `VERIFY.md`. A mismatch is a rejection.
