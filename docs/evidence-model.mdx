...
diff cannot have touched it — and [How station contracts compose](contract-composition)
— the tighten-only chain and the values registry that lets a claim be written exactly once.
