...
TOOLS = [
    ...
    Tool("vexa-values-proven", "publisher/vexa_values_proven.py",
         "python3 publisher/vexa_values_proven.py", PUBLISHER, "argparse-flat",
         "Turn a station's committed fills into an entry's proof of the contract's values."),
    Tool("vexa-station-verdict", "publisher/vexa_station_verdict.py",
         "python3 publisher/vexa_station_verdict.py", PUBLISHER, "argparse-sub",
    ...
    Tool("vexa-state-report", "kit/report/vexa_state_report.py",
         "python3 kit/report/vexa_state_report.py", CUSTOMER, "argparse-flat",
         "What is running here, before you upgrade it."),
    ...
    Tool("kit-claim", "kit/claim.sh",
         "kit/claim.sh", CUSTOMER, "bash",
         "Turn a short single-use code into a Secret, without seeing the value."),
    Tool("kit-platform-render", "kit/platform/render.sh",
         "kit/platform/render.sh", CUSTOMER, "bash",
