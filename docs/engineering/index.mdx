---
title: "Engineering"
description: "How Vexa Enterprise is built, decided and proven — internal, not published."
---

<Note>
This tab is **internal**. Publication ships the Product tab only (`docs.public.json`); nothing
