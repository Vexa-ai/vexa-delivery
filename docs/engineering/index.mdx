...
| [The evidence model](https://github.com/Vexa-ai/vexa-delivery/blob/main/spec/evidence-model.md) | Values, rank, the three subjects, contracts as channel gates — the model being built to, with a per-element BUILT / IN REVIEW / RULED / NOT STARTED state. Lives in `spec/`, which this site does not render. |
