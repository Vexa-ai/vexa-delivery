...
- **ICT third-party risk** (DORA, EBA outsourcing, NIS2) — a contracted provider with monitoring, incident support and exit clarity. Everything you run is open source and your evidence verifies offline, so exit leaves you with working software and records.
