...
<Note>
**Rung.** There is no packaging command shipped for this yet. Today the payload is the artefacts you already have — the [preflight](preflight) report, the refusal message, and the `station.tar.gz` from [step 5](install#step-5-send-the-station-bundle-back) — attached by hand.
</Note>
